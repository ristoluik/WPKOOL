...
function clean_blogging_setup() {
	...
	add_theme_support( 'custom-background', apply_filters( 'clean_blogging_custom_background_args', array(
...
function clean_blogging_scripts() {
	...
	wp_enqueue_style('clean-blogging-elements', get_stylesheet_directory_uri() . '/assets/css/elements.css');
	wp_enqueue_style('clean-blogging-typography', get_stylesheet_directory_uri() . '/assets/css/typography.css');
	wp_enqueue_style('clean-blogging-navigation', get_stylesheet_directory_uri() . '/assets/css/navigation.css');
	wp_enqueue_style('clean-blogging-content', get_stylesheet_directory_uri() . '/assets/css/content.css');
	wp_enqueue_style('clean-blogging-home-featured', get_stylesheet_directory_uri() . '/assets/css/post-featured.css');
	wp_enqueue_style('clean-blogging-recent-posts', get_stylesheet_directory_uri() . '/assets/css/recent-posts.css');
	wp_enqueue_style('clean-blogging-footer', get_stylesheet_directory_uri() . '/assets/css/footer.css');
	wp_enqueue_style('clean-blogging-responsive', get_stylesheet_directory_uri() . '/assets/css/responsive.css');
	...
	wp_localize_script('clean-blogging-navigation', 'clean_blogging_ScreenReaderText', array(
